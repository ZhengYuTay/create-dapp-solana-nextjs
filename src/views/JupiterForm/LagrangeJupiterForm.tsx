        ...
        <div className="py-4 rounded sm:px-2 xs:px-1 border-lagrangegraybackground">
          ...
          <div className="grid grid-cols-2 grid-rows-1 gap-2 px-2 py-4 overflow-hidden place-content-around">
            <button
              ...
              className="inline-flex justify-center h-11 px-2 py-2 text-base font-normal text-white uppercase rounded shadow-sm xs:w-full place-items-center border-lagrangegraybackground bg-lagrangeswapbuttoncolor hover:bg-lagrangeswapbutton focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
