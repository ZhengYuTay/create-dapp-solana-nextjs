    ...
    <div>
      ...
      <div className="mb-4 bg-white rounded shadow-lg sm:px-4 xs:px-2 border-lagrangeborder xxl:w-128 xl:w-128 lg:w-128 md:w-128 sm:w-128 xs:w-96">
        ...
        <div className="py-4 border rounded sm:px-2 xs:px-1 border-lagrangegraybackground">
          ...
          <div className="grid grid-cols-2 grid-rows-1 gap-2 px-2 py-4 overflow-hidden">
            ...
            <div className="col-span-2 col-start-2 box">
              ...
              <div className="flex justify-end">
                <div className="absolute h-12 ml-2 border rounded xs:w-40 sm:w-40 bg-lagrangegraybackground">
                  <Listbox
          ...
          <div className="grid grid-cols-2 grid-rows-1 gap-2 px-2 py-4 overflow-hidden place-content-around">
            <button
              ...
              className="inline-flex justify-center px-2 py-2 text-base font-normal text-white uppercase rounded shadow-sm h-11 xs:w-full place-items-center border-lagrangegraybackground bg-lagrangeswapbuttoncolor hover:bg-lagrangeswapbutton focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
            ...
            <button
              ...
              } xs:w-full  uppercase inline-flex justify-center place-self-end h-11 px-2 pt-2 border-lagrangebuttongray text-xl font-normal rounded shadow-sm text-lagrangebuttongray bg-gray-200 hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 border`}
              type="button"
              onClick={refresh}
              disabled={loading}
            >
        ...
        <div className="px-2 py-2 bg-white rounded shadow-lg border-lagrangeborder">
          <p className="py-2 font-normal">Total routes: {routes?.length}</p>
          {routes?.[0] &&
            (() => {
              const route = routes[0];
              return (
