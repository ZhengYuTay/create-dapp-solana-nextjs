      ...
      <div className="z-40 w-full h-screen p-10 bg-cover sm:p-5 xs:p-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center text-white">
            ...
            <p className="mr-2 xxl:ml-9 xl:ml-9 lg:ml-9 mdl:ml-9 sm:ml-9 xs:ml-2 xs:mr-0">
              <a
                href="https://drive.google.com/file/d/1GCsFz-_5rQd_RBnGr4Se0lPOgMSeAj8I/view"
                target="_blank"
                rel="noreferrer"
              >
                <p className="text-base font-normal font-display xs:text-sm sm:text-lg">
        ...
        <div className="flex items-center">
          <div className="h-full ml-12 mt-36 sm:mt-16 sm:ml-12 xs:ml-2">
            <div className=" leading-[3.5rem] font-normal text-white xxl:text-lagrange xl:text-lagrange lg:text-lagrange  md:text-lagrange  sm:text-lagrangesmallscreen xs:text-3xl font-display">
            <div className="flex item-center"><p className="font-lagrangewight">Lagrange{" "}</p>
